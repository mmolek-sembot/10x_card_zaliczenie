    ...
    <div className="space-y-6">
      <CardHeader className="px-0 pt-0">
        ...
        <p className="text-gray-500 mt-2">
          Wprowadź tekst źródłowy, na podstawie którego AI wygeneruje propozycje fiszek edukacyjnych.
          Tekst powinien mieć od 1000 do 10000 znaków.
        </p>
      </CardHeader>
      ...
      <CardContent className="px-0 pb-0">
        <TextInput
          ...
          error={sourceText.length > 0 && !isValid ? "Tekst musi mieć od 1000 do 10000 znaków" : undefined}
        />
      </CardContent>
