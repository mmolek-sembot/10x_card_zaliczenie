/* src/types.ts
   ...
   export type FlashcardDto = Pick<FlashcardRow, 'id' | 'generation_id' | 'front' | 'back' | 'created_at' | 'updated_at'> & {
   ...
   export type FlashcardsPaginatedResponseDto =
   ...
   export type GenerationsPaginatedResponseDto =
     PaginatedResponse<GenerationDto>;
   
   /* ─────────────────── Generation Error Logs (internal) ────────────── */
   
   type GenerationErrorLogRow =
